...
give @s minecraft:carrot_on_a_stick{VG_guninitialized:1b,VG_gunammo:2147483647L,display:{Name:"{\"text\":\"Rocket Gun\"}"},Enchantments:[{id:"quick_charge",lvl:1}],Unbreakable:1,HideFlags:39}
...
give @s minecraft:emerald_block 64
give @s minecraft:gold_block 64
give @s minecraft:diamond_block 64
...
item replace entity @s armor.chest with diamond_chestplate{HideFlags:5,Unbreakable:1b,Enchantments:[{id:"minecraft:vanishing_curse",lvl:1s}]} 1
