...
scoreboard players operation SM_system SM_balance_dec += SM_system SM_credit_dec

execute if score SM_system SM_balance_dec matches 100.. run scoreboard players operation SM_system SM_temp = SM_system SM_balance_dec
execute if score SM_system SM_balance_dec matches 100.. run scoreboard players operation SM_system SM_temp /= SM_system SM_const_100
execute if score SM_system SM_balance_dec matches 100.. run scoreboard players operation SM_system SM_balance_least += SM_system SM_temp
execute if score SM_system SM_balance_dec matches 100.. run scoreboard players operation SM_system SM_balance_dec %= SM_system SM_const_100
...
scoreboard players operation @s SM_b_acct_lg_cal = SM_system SM_credit_least
scoreboard players operation @s SM_b_acct_lg_cam = SM_system SM_credit_most
scoreboard players operation @s SM_b_acct_lg_cad = SM_system SM_credit_dec
scoreboard players set @s SM_b_acct_lg_ct 1
