tellraw @a[tag=TC_inminigame,team=blue,scores={TC_set_notif=1}] [{"selector":"@s"},{"text":": used 400 Team Points (Extra Supplies)","color":"yellow"}]
...
scoreboard players remove TeamPoints TC_bpoints 400