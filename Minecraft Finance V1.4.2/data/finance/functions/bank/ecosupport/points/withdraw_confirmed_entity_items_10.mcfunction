execute if score @s SM_pointwithdraw matches 10.. as @a if score @s SM_b_acct_no = SM_system SM_b_acct_no run points give @s 10
...
execute if score @s SM_pointwithdraw matches 10.. run function finance:bank/ecosupport/points/withdraw_confirmed_entity_items_10