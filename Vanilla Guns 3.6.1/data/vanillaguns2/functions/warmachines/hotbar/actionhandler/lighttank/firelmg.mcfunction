...
execute at @s run summon arrow ^ ^ ^1.5 {NoGravity:1,Tags:["VG_vehicle_lmgbullet","VG_bullet"],Color:-1,CustomName:"{\"text\":\"Unknown Player using SMG\"}",damage:1,life:1100,Owner:[]}
...
execute as @e[type=arrow,tag=VG_vehicle_lmgbullet,tag=!VG_init] run function vanillaguns2:warmachines/hotbar/actionhandler/lighttank/lmgbulletinit
