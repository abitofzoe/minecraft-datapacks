execute if score @s SM_pointwithdraw matches 100000000.. as @a if score @s SM_b_acct_no = SM_system SM_b_acct_no run points give @s 100000000
...
execute if score @s SM_pointwithdraw matches 100000000.. run function finance:bank/ecosupport/points/withdraw_confirmed_entity_items_100000000