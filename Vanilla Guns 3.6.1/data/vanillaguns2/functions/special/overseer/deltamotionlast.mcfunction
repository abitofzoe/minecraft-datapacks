execute store result score @s VG_lstknwnmtnX run data get entity @s Motion[0] 10000
execute store result score @s VG_lstknwnmtnY run data get entity @s Motion[1] 10000
execute store result score @s VG_lstknwnmtnZ run data get entity @s Motion[2] 10000
