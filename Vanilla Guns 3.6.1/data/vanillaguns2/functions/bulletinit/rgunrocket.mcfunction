...
execute at @s run data modify entity @s Owner set from entity @p UUID

execute store result entity @s Motion[0] double 0.013 run scoreboard players get @s VG_tarrowmtnX
execute store result entity @s Motion[1] double 0.013 run scoreboard players get @s VG_tarrowmtnY
execute store result entity @s Motion[2] double 0.013 run scoreboard players get @s VG_tarrowmtnZ
