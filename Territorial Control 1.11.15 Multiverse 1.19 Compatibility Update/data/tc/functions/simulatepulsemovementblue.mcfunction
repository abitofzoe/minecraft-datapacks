...
execute at @s[tag=TC_inminigame,scores={TC_pulselastrot=-180}] unless score @s[tag=TC_inminigame] TC_childspawned matches 15.. if block ~ ~ ~ #minecraft:rails[shape=north_south] if block ~1 ~ ~ #minecraft:rails[shape=east_west] run summon minecraft:area_effect_cloud ~1 ~ ~ {Age:-2147483648,Duration:-1,WaitTime:-2147483648,NoAI:1,Invisible:1,NoGravity:1,Invulnerable:1,Tags:["TC_inminigame","TC_pulsecheck","TC_pulseblue","TC_pendingimport","TC_pulseinit"],Rotation:[-90.0f,0.0f],Team:blue}
execute at @s[tag=TC_inminigame,scores={TC_pulselastrot=90}] unless score @s[tag=TC_inminigame] TC_childspawned matches 15.. if block ~ ~ ~ #minecraft:rails[shape=east_west] if block ~ ~ ~-1 #minecraft:rails[shape=north_south] run summon minecraft:area_effect_cloud ~ ~ ~-1 {Age:-2147483648,Duration:-1,WaitTime:-2147483648,NoAI:1,Invisible:1,NoGravity:1,Invulnerable:1,Tags:["TC_inminigame","TC_pulsecheck","TC_pulseblue","TC_pendingimport","TC_pulseinit"],Rotation:[-180.0f,0.0f],Team:blue}
execute at @s[tag=TC_inminigame,scores={TC_pulselastrot=90}] unless score @s[tag=TC_inminigame] TC_childspawned matches 15.. if block ~ ~ ~ #minecraft:rails[shape=east_west] if block ~ ~ ~1 #minecraft:rails[shape=north_south] run summon minecraft:area_effect_cloud ~ ~ ~1 {Age:-2147483648,Duration:-1,WaitTime:-2147483648,NoAI:1,Invisible:1,NoGravity:1,Invulnerable:1,Tags:["TC_inminigame","TC_pulsecheck","TC_pulseblue","TC_pendingimport","TC_pulseinit"],Rotation:[0.0f,0.0f],Team:blue}
execute at @s[tag=TC_inminigame,scores={TC_pulselastrot=-90}] unless score @s[tag=TC_inminigame] TC_childspawned matches 15.. if block ~ ~ ~ #minecraft:rails[shape=east_west] if block ~ ~ ~-1 #minecraft:rails[shape=north_south] run summon minecraft:area_effect_cloud ~ ~ ~-1 {Age:-2147483648,Duration:-1,WaitTime:-2147483648,NoAI:1,Invisible:1,NoGravity:1,Invulnerable:1,Tags:["TC_inminigame","TC_pulsecheck","TC_pulseblue","TC_pendingimport","TC_pulseinit"],Rotation:[-180.0f,0.0f],Team:blue}
execute at @s[tag=TC_inminigame,scores={TC_pulselastrot=-90}] unless score @s[tag=TC_inminigame] TC_childspawned matches 15.. if block ~ ~ ~ #minecraft:rails[shape=east_west] if block ~ ~ ~1 #minecraft:rails[shape=north_south] run summon minecraft:area_effect_cloud ~ ~ ~1 {Age:-2147483648,Duration:-1,WaitTime:-2147483648,NoAI:1,Invisible:1,NoGravity:1,Invulnerable:1,Tags:["TC_inminigame","TC_pulsecheck","TC_pulseblue","TC_pendingimport","TC_pulseinit"],Rotation:[0.0f,0.0f],Team:blue}
...
execute at @s[tag=TC_inminigame] run tag @e[tag=TC_inminigame,type=villager,distance=..1,tag=TC_blueguard,tag=TC_guard,tag=!TC_encircled,scores={TC_resources=1..}] add TC_pulseconnected
execute at @s[tag=TC_inminigame] run scoreboard players set @a[tag=TC_inminigame,distance=..1,team=blue] TC_supplygracem -50

scoreboard players add @s[tag=TC_inminigame] TC_pulserepeat 1

particle minecraft:crit ~ ~1 ~ 0 0 0 0 1 normal @a[tag=TC_inminigame,scores={TC_set_dust=1},team=blue]

execute as @s[tag=TC_inminigame,scores={TC_pulserepeat=1250..}] run function tc:pulsehandoffblue

execute at @s[tag=TC_inminigame,scores={TC_pulserepeat=..1249}] if block ~ ~ ~ #minecraft:rails run function tc:simulatepulsemovementblue