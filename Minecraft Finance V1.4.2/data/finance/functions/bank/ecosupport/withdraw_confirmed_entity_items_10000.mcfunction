execute if score @s SM_bankwithdraw matches 10000.. as @a if score @s SM_b_acct_no = SM_system SM_b_acct_no run eco give @s 10000
...
execute if score @s SM_bankwithdraw matches 10000.. run function finance:bank/ecosupport/withdraw_confirmed_entity_items_10000