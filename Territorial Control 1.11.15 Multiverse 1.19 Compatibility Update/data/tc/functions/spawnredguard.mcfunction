summon villager ~ ~ ~ {Profession:2,CustomName:"{\"text\":\"Red Villager Guard\"}",CustomNameVisible:1,Career:1,CareerLevel:42,CanPickUpLoot:0,PersistenceRequired:1,NoAI:1,Silent:1,Attributes:[{Name:"generic.max_health",Base:20},{Name:"generic.movement_speed",Base:0}],Offers:{},Team:red,Rotation:[90f,0f],PersistenceRequired:1,Tags:["TC_inminigame","TC_guard","TC_redguard"]}
